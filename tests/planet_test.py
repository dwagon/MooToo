...
class TestPlanet(unittest.TestCase):
    ...
    def test_finish_construction(self):
        ...
        self.assertNotIn(Building.MARINE_BARRACKS, self.planet._buildings)
        self.planet.finish_construction(con)
        self.assertIn(Building.MARINE_BARRACKS, self.planet._buildings)
    ...
    def test_available_to_build(self):
        ...
        self.planet._buildings.add(Building.MARINE_BARRACKS)
    ...
    def test_turns_to_build(self):
        ...
        planet.jobs[PopulationJobs.WORKERS] = 5  # Work Prod = 10
        planet.construction_spent = 200
        self.assertEqual(planet.turns_to_build(), int((725 - 200) / 10))
